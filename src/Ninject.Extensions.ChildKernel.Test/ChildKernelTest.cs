...
namespace Ninject.Extensions.ChildKernel
{
    ...
    public abstract class BaseChildKernelTest
    {
        ...
        {
            Assert.Throws<ChangeImmutableComponentException>(() => this.testee.Components.Add<ISelector, Selector>());
        }

        [Fact]
        public void RemoveImmutableComponent()
        {
            Assert.Throws<ChangeImmutableComponentException>(() => this.testee.Components.Remove<ISelector, Selector>());
        }

        [Fact]
        public void RemoveAllImmutableComponents()
        {
            Assert.Throws<ChangeImmutableComponentException>(() => this.testee.Components.RemoveAll(typeof(ISelector)));
        }
